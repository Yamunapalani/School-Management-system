...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: #66ffff">
                ...
                <div class="col-md-1">
                  <!-- <img src="" style="height:20pxpx;width:20px;align:center" alt=""> -->
                </div>
                                
                <a class="navbar-brand" href=""><b style="color:black;">&nbsp;&nbsp;&nbsp; <img src="https://github.com/broharigunda/HOsting_SEarchedUpdates/blob/master/Icon-Logo6.png?raw=true" alt="..." width="2%">ICON School Management System</b></a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color: #66ffff">
            <?php 
            include 'db.php';
